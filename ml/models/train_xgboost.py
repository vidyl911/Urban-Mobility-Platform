...
print(f"Date range: {df['traffic_timestamp'].min()} → "
...
train_mask = df["traffic_timestamp"].dt.date <= pd.Timestamp("2016-05-31").date()
...
test_mask = df["traffic_timestamp"].dt.date >= pd.Timestamp("2016-06-16").date()
